...
import com.lucas.osworks.domain.service.CadastroClientService;
...
public class ClienteController {
	...
	@Autowired
	private CadastroClientService cadastroCliente;
	...
	public ResponseEntity<Void> remover(@PathVariable Long clienteId) {
		...
		cadastroCliente.deleteById(clienteId);
